...
function html5blank_header_scripts() {
    if ( $GLOBALS['pagenow'] != 'wp-login.php' && ! is_admin() ) {
            ...
            wp_register_script( 'app', get_template_directory_uri() . '/dist/js/app.min.js', array(), time() );
...
function html5blank_conditional_scripts() {
    if ( is_page( 'pagenamehere' ) ) {
        ...
        wp_register_script('app', get_template_directory_uri() . '/dist/js/app.js', array( 'jquery' ), time() );
        wp_enqueue_script('app' );
    }
}
...
function html5blank_styles() {
        // Custom CSS
        wp_register_style('app', get_template_directory_uri() . '/dist/css/app.css', array(), time() );
